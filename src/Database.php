...
final class Database
{
    ...
    public static function connection(): PDO
    {
        ...
        $path = str_starts_with($relative, '/') ? $relative : dirname(__DIR__) . '/' . $relative;
    ...
    private static function migrate(PDO $pdo): void
    {
        ...
        CREATE TABLE IF NOT EXISTS recipients (
            ...
            relationship TEXT NOT NULL, name TEXT NOT NULL, kana TEXT NOT NULL, birth_date TEXT NOT NULL,
            ...
            vaccine_method TEXT NOT NULL, dose_no INTEGER NOT NULL, appointment_date TEXT NOT NULL,
