...
長崎北徳洲会病院の院内電子カルテネットワークで、一時的に使用する**職員家族専用**の事前申し込みです。職員本人は対象ではありません。Windows 11、Apache 2.4、PHP 8.3、SQLiteで動作します。
...
- 高校生以上：10月1日～12月28日の平日、`9:00～12:00`または`17:00～20:00`、注射
- 小児（6か月～中学生）：10月8日・22日・29日、`16:30～18:30`、注射
- 2歳～小学生：10月8日・22日・29日、`16:30～18:30`、注射または経鼻ワクチン

接種希望日は`2026/10/08（木）`のように曜日付きで表示します。診療時間は連続した時間帯を1つの選択肢として表示します。
