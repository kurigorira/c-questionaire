...
if ($path === '/submit' && $method === 'POST') {
    ...
    $allowed = ['target_group'=>['高校生以上','小児（6か月～中学生）','2歳～小学生'],'relationship'=>['配偶者','子','その他家族'],'gender'=>['男性','女性','回答しない'],'patient_history'=>['あり','なし','不明'],'wants_second_dose'=>['あり','なし'],'vaccine_method'=>['injection','nasal'],'dose_no'=>['1']];
