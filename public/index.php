...
<section class="notice"><strong>接種について</strong><div class="notice-grid"><p><b>高校生以上・65歳以上</b><br>10月1日〜12月28日の平日<br>午前診療 9:00〜12:00<br>夕診療 17:00〜20:00</p><p><b>6か月〜中学生</b><br>{$childDates}<br>16:30〜18:30</p><p><b>経鼻ワクチン</b><br>2歳〜小学生・1回接種<br>注射も選択できます</p></div></section>
...
if ($path === '/submit' && $method === 'POST') {
    ...
    $allowed = ['target_group'=>['高校生以上','65歳以上','小児（6か月～中学生）','2歳～小学生'],'relationship'=>['配偶者','子','その他家族'],'gender'=>['男性','女性','回答しない'],'patient_history'=>['あり','なし','不明'],'wants_second_dose'=>['あり','なし'],'vaccine_method'=>['injection','nasal'],'dose_no'=>['1']];
